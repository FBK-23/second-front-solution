...
export class CarouselsComponent {
  ...
  constructor(
    ...
    this.slides[0] = [
      {
        id: 0,
        src: './assets/img/avatars/drone11.png',
        title: '',
      ...
      {
        id: 1,
        src: './assets/img/avatars/drone15.jpg',
        title: '',
        subtitle: 'Nulla vitae elit libero, a pharetra augue mollis interdum.'
      },
      {
        id: 2,
        src: './assets/img/avatars/drone9.jpg',
        title: '',
        subtitle: 'Nulla vitae elit libero, a pharetra augue mollis interdum.'
      },
      {
        id: 3,
        src: './assets/img/avatars/drone4.jpeg',
        title: '',
      ...
      {
        id: 5,
        src: './assets/img/avatars/drone7.jpg',
        title: '',
        subtitle: 'Nulla vitae elit libero, a pharetra augue mollis interdum.'
      },
      ...
      {
        id: 6,
        src: './assets/img/avatars/drone10.jpg',
        title: '',
        subtitle: 'Nulla vitae elit libero, a pharetra augue mollis interdum.'
      },
      ...
      {
        id: 7,
        src: './assets/img/avatars/drone12.jpg',
        title: '',
        subtitle: 'Nulla vitae elit libero, a pharetra augue mollis interdum.'
      },
      {
        id: 8,
        src: './assets/img/avatars/drone8.jpg',
        title: '',
        subtitle: 'Nulla vitae elit libero, a pharetra augue mollis interdum.'
      },
    ];
    ...
    this.slides[1] = [
      {
        id: 0,
        src: "./assets/img/avatars/Boeing1.jpg",
        title: ['Boeing','https://www.boeing.fr/'],
        subtitle: '	Forever new frontiers'
      },
      {
        id: 1,
        src: "./assets/img/avatars/qatar.png",
        title: ['Qatar Airline','https://www.qatarairways.com/fr-tn/homepage.html'],
        subtitle: 'Going Places Together '
      },
      {
        id: 2,
        src: "./assets/img/avatars/airbus1.jpg",
        title: ['AirBus','https://www.airbus.com/en'],
        subtitle: ' We make it fly'
      }
    ];
